...
const uint32_t rightPipeMap[num_layers][num_keys_per_pipe] = {
  [LAYER_BASE] = {
     MO(LAYER_FN), HID_KEY_Y, HID_KEY_U, HID_KEY_I, HID_KEY_O, HID_KEY_P, HID_KEY_BACKSPACE,
     HID_KEY_SPACE, HID_KEY_H, HID_KEY_J, HID_KEY_K, HID_KEY_L, HID_KEY_SEMICOLON, HID_KEY_ENTER,
     MO(LAYER_SYM), HID_KEY_N, HID_KEY_M, HID_KEY_COMMA, HID_KEY_PERIOD, HID_KEY_SLASH, HID_KEY_DELETE,
  },
  [LAYER_GAME] = {},
  [LAYER_NUM] = {
  ...
  [LAYER_SYM] = {
    ___, S(HID_KEY_6), C(HID_KEY_ARROW_LEFT), HID_KEY_ARROW_UP, C(HID_KEY_ARROW_RIGHT), S(HID_KEY_MINUS), ___,
